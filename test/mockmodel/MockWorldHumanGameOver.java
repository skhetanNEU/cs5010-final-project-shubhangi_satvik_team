...
/**
 * Mock class for model with human player and game is over.
 */
public class MockWorldHumanGameOver implements WorldInterface {

  private StringBuilder log;
  private final String uniqueCode;

  /**
   * Constructor for setting up the Mock class for model with human player and game is over.
   * @param log StringBuilder for appending the actions.
   * @param uniqueCode Unique code to verify that correct method is called.
   */
  public MockWorldHumanGameOver(StringBuilder log, String uniqueCode) {
    this.log = log;
