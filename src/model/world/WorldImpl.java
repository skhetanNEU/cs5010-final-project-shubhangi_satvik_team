...
public class WorldImpl implements WorldInterface {
  ...
  @Override
  public void takeTurnForComputerPlayer() {
    checkIfPlayersExistToPlayGame();
    ...
    if (currentPlayerRoom.isTargetPlayerInRoom()
      ...
      attackTargetPlayer(maxDamageWeaponChosen);
