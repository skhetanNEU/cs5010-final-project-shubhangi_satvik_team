...
public class ComputerPlayer extends AbstractPlayer{
    ...
    public String setPlayerRoom(String roomName) {
        ...
        String randomlySelectedNeighbor =
                neighborsOfCurrentRoom.get(new RandomClass().getRandomWithinBound(neighborsOfCurrentRoom.size()));
    ...
    public String pickWeapon(String weaponName){
        ...
        if(weaponsInRoom.size() == 0){
            throw new IllegalArgumentException("Room doesn't have any weapons");
        }
    ...
    public int attackTarget(String weaponName){
        ...
        WeaponInterface weapon = removeWeaponFromPlayer(weaponNameForAttack);
